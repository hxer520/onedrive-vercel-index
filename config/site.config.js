...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'luoyu.huang@outlook.com',
  ...
  protectedRoutes: ['/【丰团团】资源共享/资料', '/🥟 Some test files/Protected route],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:ringo@fengxtuan.com',
